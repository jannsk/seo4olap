...
public class Olap2SparqlAlgorithmSesameIterator implements PhysicalOlapIterator {
	...
	public Olap2SparqlAlgorithmSesameIterator(
			PhysicalOlapIterator inputiterator, OlapSesameEngine engine,
	...
	private void evaluateDices(List<List<Node[]>> membercombinations,
		...
		if (membercombinations != null && !membercombinations.isEmpty() && hierarchysignature != null && !hierarchysignature.isEmpty()) {
